...
const recibirEmail= async(email)=>{
    ...
    await transporter.sendMail({
        ...
        subject: "Tienda Ropa",
        html: `<div>
        <a href="https://tiendaropa.onrender.com/Empleado/activare?email=${email}" target="_blank">Activar Cuenta</a>      
        </div>`,
    });
}
...
const recibirEmailCliente= async(email)=>{
    ...
    await transporter.sendMail({
        ...
        subject: "Tienda Ropa",
        html: `<div>
        <a href="https://tiendaropa.onrender.com/Cliente/activare?email=${email}" target="_blank">Activar Cuenta</a>      
        </div>`,
    });
}
